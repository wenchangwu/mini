 ...
 */
@XmlRootElement(name="ThirdPartyUnbindRequest")
@XmlAccessorType(XmlAccessType.FIELD)
public class ThirdPartyUnbindRequest extends BaseRequestDTO {
	...
	public String toString() {
		return "ThirdPartyUnbindRequest [orgId=" + orgId + ", orgUserId="
				+ orgUserId + ", userId=" + userId + ", psamNo=" + psamNo
				+ ", orgExInfo=" + orgExInfo + "]";
	}
