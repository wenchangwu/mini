 ...
 * U盾PSAM卡入库
 * @author qw
 * @UD_PsamInStoreCommand.java
 * @2011-5-23 下午03:18:51
 */
@Component(value = "udPsamInStoreCommand")
public class UDPsamInStoreCommand extends AbstractCardCommand {
		...
		if (obj instanceof String[]) {
			...
			if (psamNos != null && psamNos.length > 0) {
				...
				for (int i = 0; i < psamNos.length; i++) {
					...
					cardInfo.setType(CardType.USER_UD);
